...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '随笔记💼💰，记录我的生活随笔与理票票，在这里，我将分享我的资产逐步累积之旅🚀，探索无论是💰的增长，还是人生的感悟✨，都将被我用文字记录下来，与大家共同分享。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: 章先生随笔记 || 'NotionNext', // 您的昵称 例如 tangly1024
  BIO: 章先生 || '一个普通的干饭人🍚', // 作者简介
  LINK: www.qqq360.com || 'https://tangly1024.com', // 网站地址
